...
<section id="tabs" style="width:100%!important" >
    <div class="container justify-content-center align-self-center"  style="background-color:#082052!important">
        ...
        <div class="row py-5">
            <div class="col-xs-12 col-md-8 col-lg-12 ">
                <nav>
                    <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                        <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Add Building</a>
                        <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">Add Room</a>
                        <a class="nav-item nav-link" id="nav-about-tab" data-toggle="tab" href="#nav-about" role="tab" aria-controls="nav-about" aria-selected="false">Allocate Keys</a>
                    </div>
                </nav>
                <div class="tab-content py-3 px-3 px-sm-0 " id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        <div class=" container-fluid justify-content-center align-self-center">
                     @include('building.index')
                        </div>
