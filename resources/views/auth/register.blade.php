...
<div>
    <div class="row justify-content-center">
        <div class="col">
            <div class="card text-light mx-auto" style="background-color:#082052!important">
                <div class="card-header"  style="background-color:#FF5733!important">{{ __('Register') }}</div>
